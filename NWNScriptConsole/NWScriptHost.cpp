...
Return Value:
	...
	The routine returns true if the action was exected, else false if a fatal
	error occured.
...
--*/
{
	...
	if (m_JITEngine.get( ) != NULL)
	{
		try
		{
			...
			CodeGenParams.CodeGenFlags     = NWCGF_SAVE_OUTPUT | NWCGF_ENABLE_SAVESTATE_TO_VMSTACK;
