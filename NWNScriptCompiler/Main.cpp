...
--*/
{
	...
	if (Status != NO_ERROR)
		throw std::runtime_error( "Unable to open NWN2 registry key" );
...
--*/
{
	...
	if (!Quiet)
	{
		wprintf(
			...
			L"Copyright (C) 2008-2011 Skywing.\n"
			L"Portions copyright (C) 2003-2003, Edward T. Smith.\n"
	...
	if ((Error) || (InFiles.empty( )))
	{
		wprintf(
			L"Usage:\n"
			L"NWNScriptCompiler [-1acdegloq] [-b batchoutdir] [-h homedir]\n"
